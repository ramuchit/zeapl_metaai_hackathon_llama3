                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <table id="user_group_datatable" data-search="true" data-toggle="table"
                                    ...
                                    <?php $keywordData = file_get_contents("../data/intents/intents.json"); 
                                    ...
                                    <tbody class="text-center">
                                        <?php foreach ($keywords as $key => $keyword) { 
                                            ...
                                            <tr>
                                                <td><?php echo $id; ?></td>
                                                <?php foreach($keyword as $ikey=>$ival) { ?>
                                                <td><?php echo $ikey; ?> </td>
                                                <td><?php echo $ival; ?> </td>
                                                <?php } ?>
                                                <td>
...
function buttons() {
    return {
        btnAdd: {
            html: '<a class="btn btn-danger" href="create" title="Add Content" id="addrecord1"><i class="bi bi bi-plus"></i><span>New Intent</span></a>'
        }
    }
}
</script>
