...
!(function (t, e) {
  ...
  var Mt = W,
    ...
    me = function (t, e) {
      ...
      if (n) {
        if (
          (void 0 === e && (e = "default"), (i = he(n, t, e)), !ue(i) || de(i))
        )
          return i;
  ...
  var Da =
    ...
    sr = (function () {
      var t = /a/,
        e = /b*/g;
      return (
        za(er, t, "a"), za(er, e, "a"), 0 !== t.lastIndex || 0 !== e.lastIndex
      );
    })(),
    lr = Ka.BROKEN_CARET,
    cr = void 0 !== /()??/.exec("")[1];
      ...
      if (
        ...
        f
          ? o
            ...
            : (l.lastIndex = 0)
          : sr && o && (l.lastIndex = l.global ? o.index + o[0].length : n),
        cr &&
          o &&
          o.length > 1 &&
        ...
        [
          ...
          function (t, o) {
            ...
            for (var f = 0, p = 0, g = []; p < r.length; ) {
              ...
              if (
                null === b ||
                (v = Ls(Rs(u.lastIndex + (Vs ? p : 0)), r.length)) === f
              )
                p = $s(r, p, c);
              else {
    ...
    Qs = function (t) {
      return function (e) {
        for (var i, n = Ys(e), o = Ks(n), a = o.length, r = 0, s = []; a > r; )
          (i = o[r++]), (Ws && !Js(n, i)) || Xs(s, t ? [i, n[i]] : n[i]);
        return s;
      };
    },
    ...
    mh = !ah(function () {
      ...
      if (!(lh && lh > 3)) {
        ...
        for (
          ...
          (e = dh[n].k.charAt(0)), o.charAt(o.length - 1) !== e && (o += e);
  ...
  Or("search", function (t, e, i) {
    return [
      ...
      function (t) {
        ...
        var s = au(n, o);
        return (
          iu(n.lastIndex, r) || (n.lastIndex = r), null === s ? -1 : s.index
        );
      },
    ];
  });
  ...
  var Ou = p,
    ...
    Id =
      ...
      (!Cd ||
        ...
        sd(function () {
          return (
            (Od[fd] = !1), pd(kd) != kd || pd(Od) == Od || "/a/i" != pd(kd, "i")
          );
        }));
  if (Ju("RegExp", Id)) {
    for (
    ...
    sp = function (t, e, i, n, o, a, r) {
      ...
      if (
        (v &&
          ...
          s.next &&
          (Hf(s) !== Yf && (Mf ? Mf(s, Yf) : Bf(s[Xf]) || qf(s, Xf, ep)),
          Uf(s, u, !0)),
        Gf &&
          o == Zf &&
          p &&
        ...
        if (((l = { values: h(Zf), keys: a ? g : h(Qf), entries: h(tp) }), r))
  ...
  Cp(
    { target: "Array", proto: !0, forced: !jp },
    {
      splice: function (t, e) {
        ...
        if (((o.length = n), i < n)) {
          for (a = h; a < c - n; a++)
            (s = a + i), (r = a + n) in l ? (l[s] = l[r]) : delete l[s];
          for (a = c; a > c - n + i; a--) delete l[a - 1];
        } else if (i > n)
          for (a = c - n; a > h; a--)
            (s = a + i - 1), (r = a + n - 1) in l ? (l[s] = l[r]) : delete l[s];
  ...
  var pg = ho,
    ...
    bg = [1, 2];
  pg(
    { target: "Array", proto: !0, forced: String(bg) === String(bg.reverse()) },
    {
      reverse: function () {
  ...
  Ag(
    {
      ...
      forced:
        !!(
          Lg || ((Ig = Rg(String.prototype, "startsWith")), !Ig || Ig.writable)
        ) && !Lg,
    },
    {
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              "string" == typeof t.icons &&
                (t.icons = tv.calculateObjectValue(null, t.icons)),
                (t.iconsPrefix =
                  t.iconsPrefix ||
              ...
              (this.header = {
                ...
                this.options.columns.forEach(function (i, o) {
                  ...
                  a.push(
                    "<tr"
                      .concat(
                        tv.sprintf(' class="%s"', t._headerTrClasses[o]),
                        " "
                      )
                      .concat(
                        tv.sprintf(' style="%s"', t._headerTrStyles[o]),
                        ">"
                      )
                  );
                  var r = "";
                  ...
                  r && "right" !== t.options.detailViewAlign && a.push(r),
                    i.forEach(function (i, n) {
                      ...
                      if (
                        ...
                        a.push(
                          "<th".concat(
                            tv.sprintf(' title="%s"', i.titleTooltip)
                          ),
                          i.checkbox || i.radio
                            ? tv.sprintf(
                                ' class="bs-checkbox %s"',
                            ...
                            : g || r,
                          tv.sprintf(' style="%s"', h + d + p.join("; ")),
                          tv.sprintf(' rowspan="%s"', i.rowspan),
                          tv.sprintf(' colspan="%s"', i.colspan),
                          tv.sprintf(' data-field="%s"', i.field),
            ...
            value: function () {
              ...
              if (
                ...
                if (o.showSearchButton || o.showSearchClearButton) {
                  ...
                  U = o.search
                    ? tv.sprintf(this.constants.html.inputGroup, M, z)
                    : z;
                }
                a.push(
                  tv.sprintf(
                  ...
                  ? this.data.filter(function (n, a) {
                      for (var r = 0; r < t.header.fields.length; r++)
                        if (
                          ...
                          var s = tv.isNumeric(t.header.fields[r])
                          ...
                          if (
                            (t.options.searchAccentNeutralise &&
                              (c = tv.normalizeAccent(c)),
                            l &&
                              l.searchFormatter &&
                              (c = tv.calculateObjectValue(
                                l,
                            ...
                            if (
                              ...
                              (t.options.regexSearch && tv.regexCompare(c, e))
                            )
                              return !0;
                            var d =
                                /(?:(<=|=>|=<|>=|>|<)(?:\s+)?(-?\d+)?|(-?\d+)?(\s+)?(<=|=>|=<|>=|>|<))/gm.exec(
              ...
              if (e.pagination) {
                  ...
                  d.forEach(function (i, n) {
                    ...
                    (!e.smartDisplay ||
                      ...
                      ((o = h
                        ...
                        : ""),
                      p.push(
                        tv.sprintf(t.constants.html.pageDropdownItem, o, i)
                      ));
                  }),
                    p.push(
                ...
                if (
                  ...
                  c.push(
                    '<div class="'
                      .concat(this.constants.classes.pull, "-")
                      .concat(e.paginationHAlign, ' pagination" style="float:right !important;margin-top: 0px !important;">'),
                    tv.sprintf(
                      this.constants.html.pagination[0],
                      tv.sprintf(" pagination-%s", e.iconSize)
                    ),
                    tv.sprintf(
          ...
          },
          {
            ...
            value: function (t, e, i, o) {
              ...
              if (!(tv.findIndex(this.hiddenRows, t) > -1)) {
                ...
                r.push(
                  "<tr",
                  tv.sprintf(" %s", d.length ? d.join(" ") : void 0),
                  tv.sprintf(' id="%s"', Array.isArray(t) ? void 0 : t._id),
                  tv.sprintf(
                    ' class="%s"',
                  ...
                  tv.sprintf(
                    ' data-uniqueid="%s"',
                    tv.getItemField(t, this.options.uniqueId, !1)
                  ),
                  tv.sprintf(
                    ' data-has-detail-view="%s"',
                    this.options.detailView &&
                      tv.calculateObjectValue(null, this.options.detailFilter, [
                        e,
                        t,
                      ])
                      ? "true"
                  ...
                  this.header.fields.forEach(function (i, n) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        b && (v = ' style="'.concat(b, '"')),
                        t["_".concat(i, "_id")] &&
                          (p = tv.sprintf(' id="%s"', t["_".concat(i, "_id")])),
                        t["_".concat(i, "_class")] &&
                          (g = tv.sprintf(
                            ' class="%s"',
                            t["_".concat(i, "_class")]
                      ...
                      if (
                        t["_".concat(i, "_data")] &&
                        !tv.isEmptyObject(t["_".concat(i, "_data")])
                      )
                        for (
                          var j = 0,
                            F = Object.entries(t["_".concat(i, "_data")]);
                          j < F.length;
                          j++
                        ) {
                          var _ = s(F[j], 2),
                      ...
                      if (o.checkbox || o.radio) {
                        ...
                        var V = o.class || "",
                          B =
                            tv.isObject(u) && u.hasOwnProperty("checked")
                              ? u.checked
                              : (!0 === u || h) && !1 !== u,
                        ...
                        (l = [
                          ...
                          '<label>\n            <input\n            data-index="'
                            ...
                            .concat(d, '"\n            ')
                            .concat(
                              tv.sprintf('value="%s"', t[a.options.idField]),
                              "\n            "
                            )
                            .concat(
                              tv.sprintf(
                        ...
                        var H = a.options.showHeader
                          ? '<span class="card-view-title '
                              .concat(f.classes || "", '"')
                              .concat(v, ">")
                              .concat(tv.getFieldTitle(a.columns, i), "</span>")
                          : "";
                    ...
                    '<tr class="no-records-found">'.concat(
                      tv.sprintf(
                        ...
                        this.getVisibleFields().length +
                          tv.getDetailViewIndexOffset(this.options),
            ...
            value: function () {
              ...
              this.$body
                ...
                .on("click dblclick", function (e) {
                  ...
                  if (!n.find(".detail-icon").length) {
                    var o = n.parent(),
                      ...
                      h =
                        t.getVisibleFields()[
                          c - tv.getDetailViewIndexOffset(t.options)
                        ],
                    ...
                    if (
                      ...
                      var f = o.find(
                        tv.sprintf('[name="%s"]', t.options.selectItemName)
                      );
                      f.length && f[0].click();
                    }
                    "click" === e.type &&
                ...
                (this.$selectItem = this.$body.find(
                  tv.sprintf('[name="%s"]', this.options.selectItemName)
                )),
                ...
                this.header.events.forEach(function (e, n) {
                  ...
                  if (o) {
                    if (
                      ("string" == typeof o &&
                        (o = tv.calculateObjectValue(null, o)),
                      !o)
                    )
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (
                ...
                if (
                  (tv.isEmptyObject(this.filterColumnsPartial) ||
                  ...
                  var d = i.default.extend(
                    {},
                    tv.calculateObjectValue(null, this.options.ajaxOptions),
                    {
                ...
                u.find("> *").each(function (e, n) {
                  ...
                  if (
                    ...
                    var s = e - tv.getDetailViewIndexOffset(t.options),
                      l = t.$header_.find(
                        tv.sprintf('th[data-field="%s"]', c[s])
                      );
              ...
              if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                ...
                this.data.forEach(function (o, a) {
                  ...
                  if (e.values.includes(o[e.field])) {
                    var r = i.$selectItem
                        .filter(":enabled")
                        .filter(tv.sprintf('[data-index="%s"]', a)),
                      s =
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.data[t],
                n = this.$body.find(
                  tv.sprintf('> tr[data-index="%s"][data-has-detail-view]', t)
                );
              if (
